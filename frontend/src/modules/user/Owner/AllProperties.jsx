...
const AllProperties = () => {
   ...
   const getAllProperty = async () => {
      try {
         const response = await axios.get('https://houserentapp.onrender.com/api/owner/getallproperties', {
   ...
   const saveChanges = async (propertyId, status) => {
      try {
         ...
         const res = await axios.patch(`https://houserentapp.onrender.com/api/owner/updateproperty/${propertyId}`, formData, {
            headers: { 'Authorization': `Bearer ${localStorage.getItem("token")}` }
         })
         if (res.data.success) {
   ...
   const handleDelete = async (propertyId) => {
      ...
      if (assure) {
         try {
            const response = await axios.delete(`https://houserentapp.onrender.com/api/owner/deleteproperty/${propertyId}`, {
               headers: { 'Authorization': `Bearer ${localStorage.getItem("token")}` }
            });
