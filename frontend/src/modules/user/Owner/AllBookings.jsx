...
const AllProperty = () => {
   ...
   const getAllProperty = async () => {
      try {
         const response = await axios.get('https://houserentapp.onrender.com/api/owner/getallbookings', {
   ...
   const handleStatus = async (bookingId, propertyId, status) => {
      try {
         const res = await axios.post('https://houserentapp.onrender.com/api/owner/handlebookingstatus', { bookingId, propertyId, status }, {
            headers: { 'Authorization': `Bearer ${localStorage.getItem("token")}` }
         })
         if (res.data.success) {
